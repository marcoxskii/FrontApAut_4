              ...
              <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="rounded-md shadow">
                     <Link
                      to="/scan"
                      className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-slate-900 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10"
                    >
                      <Camera className="mr-2 h-5 w-5" /> Identificar
                    </Link>
                  </div>
                </div>
              </div>
